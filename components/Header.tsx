          ...
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              {[
                ...
                >
                  <Link
                    href={item.href}
                    className="text-gray-700 dark:text-gray-300 hover:text-green-600 dark:hover:text-green-400 font-medium transition-colors duration-200 relative group"
                  >
                    {item.label}
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="hidden sm:flex items-center space-x-3">
                ...
                >
                  <AiOutlineInstagram className="w-5 h-5 text-pink-600" />
                </motion.a>
                <motion.a
                  href="#"
                  initial={{opacity: 0, scale: 0}}
                  ...
                  className="w-10 h-10 bg-gray-100 dark:bg-gray-800 rounded-full flex items-center justify-center hover:bg-green-100 dark:hover:bg-green-900 transition-colors duration-200"
                >
                  <AiOutlineWhatsApp className="w-5 h-5 text-green-600" />
                </motion.a>
              </div>
              ...
              >
                <Button className="bg-green-600 hover:bg-green-700 text-white font-semibold px-6 py-2 rounded-lg shadow-lg hover:shadow-xl transition-all duration-200">
                  Register Now
                </Button>
              </motion.div>
              ...
              <Sheet open={isMenuOpen} onOpenChange={setIsMenuOpen}>
                ...
                <SheetContent side="right" className="w-80 bg-white dark:bg-gray-300 border-l border-gray-200 dark:border-gray-700 overflow-y-scroll">
                <SheetClose className="float-right top-0 right-0">
                  <Button variant="ghost" size="icon" className="-top-3 -right-2 bg-gray-100  relative w-10 flex justify-center items-center md:hidden h-10 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 z-90" >
                        ...
                        {[
                          ...
                          >
                            ...
                            >
                              ...
                              <span className="text-lg font-medium text-gray-900 dark:text-white group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors duration-200">
                                {item.label}
                              </span>
                            </Link>
                          </motion.div>
