        ...
        <div className="flex flex-col min-h-screen  bg-background">
            ...
            <div className="h-screen flex flex-col gap-6" >
                <div
                    ...
                    <motion.div className={'flex w-[120vw]  gap-4 px-4'} style={{x: spring}}>
                        <div>
                ...
                <div
                    ...
                    <motion.div className={'flex w-[120vw]  gap-4 px-4'} style={{x: springX}}>
                        <div>
                            <img src={"/carousel/1.jpg"} alt="section-image"
                                 className={'image rounded-lg'}/>
                        </div>
                ...
                <div
                    className="top-96 flex flex-col items-center justify-center scroll-smooth overflow-x-hidden">
                    <motion.div className={'flex w-[120vw]  gap-4 px-4'} style={{x: springX2}}>
                        <div>
                            <img src={"/carousel/1.jpg"} alt="section-image"
                                 className={'image rounded-lg'}/>
                        </div>
                    ...
                    <div>
                        <div className={' '}>
                            ...
                            <div className={'relative'}>
                                <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width={128} className={'absolute bottom-4 z-10 left-28'} viewBox="0 0 200.000000 200.000000"
...
-42 37 c-63 57 -139 74 -211 48z"/>
                            ...
                            <svg className={'z-30 bottom-8 relative left-14'} width="300" height="62"
                                ...
                                <rect width="300" height="66" rx="10" stroke="white" strokeWidth="40"
                    ...
                    <motion.div initial={{opacity:0.3}} whileInView={{opacity:1}} transition={{delay:0.3}}>
                        <div className="flex flex-col justify-end">
                            ...
                            <p className="text-4xl font-light text-right">
                                RUN & EAT Dubai is a unique experience for our participants, offering you not only to test
                                your physical abilities, but also to enjoy the rich culinary diversity of the United Arab
                                Emirates.
                            </p>
                        </div>
                    </motion.div>
                    ...
                    <motion.div initial={{opacity: 0.3}} whileInView={{opacity: 1}} transition={{delay: 0.3}}>
                        <div className="flex flex-col justify-end">
                            ...
                            <p className="text-4xl font-light text-left">
                                Our athletes can choose 5 km or 10 km distances to run. Our young participants will run a children's race at distances of 500 m and 1 km.
                            </p>
                        </div>
                    </motion.div>
                }
                    ...
                    <motion.div initial={{opacity: 0.3}} whileInView={{opacity: 1}} transition={{delay: 0.3}}
                        ...
                        <div className={'flex flex-col gap-3 justify-center items-start '}  >
                            <h2 className={'flex items-center justify-center gap-2 font-bold uppercase text-3xl text-center'}>
                                <span className={'relative bottom-[2px]'}><SlotCounter value={5} animateOnVisible={true}/></span> km
                            </h2>
            ...
            leftHalf={<div className={'flex flex-col gap-6 relative -top-10 items-start justify-start'}>
                <div className={'flex h-1/2 justify-start left-0 relative w-full'}>
                    ...
                    <motion.img initial={{rotate:0}} whileInView={{rotate:25}} transition={{duration:0.4, delay:0.3, ease:"backOut"}} className={'relative -left-40'}  width={512} height={512} src="/TShirtWhite.svg" alt="Tshirt"/>
                ...
                <div className={'flex justify-end h-1/2 relative bottom-40  w-full'}>
                    <motion.img initial={{rotate: 0, scale:1.2}}
                                whileInView={{rotate: -25, transition: {duration: 0.4, delay: 0.6, ease: "backOut"}}}
                                whileHover={{scale: 1.3, transition: {delay: 0}}} className={'relative top-10 right-52'}
                                width={128} height={128} src="/medal.svg" alt="Tshirt"/>
            ...
            {/*<Reviews/>*/}
            {/*<Download/>*/}
            <div className={'min-h-[80vh] flex flex-col gap-6 items-start justify-start mt-32 w-1/2 mx-auto'}>

                <motion.div initial={{y:30, opacity:0}} whileInView={{y:0, opacity:1,transition:{duration:0.4,delay:.1}}} className="text-left text-3xl font-bold">
                    Join our race with friends, family or run with a corporate team.
                </motion.div>
                <motion.div initial={{y:30, opacity:0}} whileInView={{y:0, opacity:1,transition:{duration:0.7,delay:.2}}} className="text-left text-5xl font-bold">
                    OUR RACE MAKES YOU FALL IN LOVE WITH RUNNING
                </motion.div>
                <motion.button initial={{y:30, opacity:0}} whileInView={{y:0, opacity:1,transition:{duration:1.2,delay:.3}}}  whileHover={{scale:1.2}} whileTap={{scale:1.1}} className="px-8 py-2 mt-32 w-full text-2xl rounded-lg bg-text text-black font-light mx-auto">
                    REGISTER
                </motion.button>
            </div>
            <Footer/>
